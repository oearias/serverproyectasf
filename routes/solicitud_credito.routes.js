...
router.put('/:id', [
        ...
        body('cliente.curp').toUpperCase(),
        body('cliente.rfc').toUpperCase(),
        body('aval.nombre').toUpperCase(),
        body('aval.apellido_paterno').toUpperCase(),
        body('aval.apellido_materno').toUpperCase(),
        body('aval.calle').toUpperCase(),
        body('negocio.nombre').toUpperCase(),
        body('negocio.giro').toUpperCase(),
